-- Migration to fix glossary function naming issues
-- This migration addresses the parameter naming conflict in update_series_glossary_json function

-- First, drop all existing glossary functions to avoid conflicts
...
DROP FUNCTION IF EXISTS public.update_series_glossary_json_alt(UUID);
